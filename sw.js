...
var SHELL = ['/reclaim-buddy/', '/reclaim-buddy/index.html', '/reclaim-buddy/app.html', '/reclaim-buddy/manifest.json', '/reclaim-buddy/icon-192.png', '/reclaim-buddy/icon-512.png', '/reclaim-buddy/icon.svg'];
